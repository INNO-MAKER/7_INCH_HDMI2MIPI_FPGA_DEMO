...
xst -ifn xst.scr
move lvds_8ch_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\lvds_8ch_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc lvds_8ch_exdes.ucf lvds_8ch_exdes

echo 'Running map'
map -timing lvds_8ch_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm lvds_8ch_exdes -w routed.ncd routed.v
cd ..
