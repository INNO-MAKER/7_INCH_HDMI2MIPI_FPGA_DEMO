...
vlog -work work lvds_8ch_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax lvds_8ch_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.lvds_8ch_tb work.glbl
