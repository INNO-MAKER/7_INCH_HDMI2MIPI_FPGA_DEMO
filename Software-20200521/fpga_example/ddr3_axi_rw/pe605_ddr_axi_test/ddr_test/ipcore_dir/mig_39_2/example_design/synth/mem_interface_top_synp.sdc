...
define_attribute          {v:work.axi4_tg} syn_hier {hard}
define_attribute          {v:work.axi4_wrapper} syn_hier {hard}
define_attribute          {v:work.cmd_prbs_gen_axi} syn_hier {hard}
define_attribute          {v:work.data_gen_chk} syn_hier {hard}
define_attribute          {v:work.s6_axi4_tg} syn_hier {hard}
define_attribute          {v:work.tg} syn_hier {hard}
